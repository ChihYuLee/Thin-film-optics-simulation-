function [X,A,R,T,Phi,Psi]= transfer_matrix_trans(theta0, n0, max_lambda, min_lambda,number_layers, n, k, d, pol)
...
for r=1:1:matrix_lambda+1
    ...
    for m=2:1:number_layers    
        ...
        Psi(r)=atan((-imag(eta0*B+C))/real(eta0*B+C));
